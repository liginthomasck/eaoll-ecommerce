...
<th>status</th>
 ...
 <?php
            ...
            $val=$_SESSION['userid'];
			$d=Date('Y-m-d');
            $s="select additem.itemCategory,additem.itemName,additem.Description,additem.amount,additem.usages,additem.image,orders.status from additem inner join orders on orders.itemid=additem.id where orders.userid=$val";
            $rs=$db->selectData($s);
