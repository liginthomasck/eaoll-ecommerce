...
<th>status</th>
 ...
 <?php
            ...
            $db=new DatabaseCon();
			$d=Date('Y-m-d');
            $s="select *from additem where EDate<'$d' and id not in (select itemid from wallet)";
            $rs=$db->selectData($s);
...
?>
 ...
 <td><?php echo $row['sDate'];?></td>
  ...
  <td><a href="wallet.php?id=<?php echo $row['id'];?>&uid=<?php echo $row['userid'];?>&name=<?php echo $row['itemName'];?>">Buy</a></td>
